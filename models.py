...
class User(db.Model, UserMixin, TimestampMixin):
    ...
    @property
    def is_staff(self): return self.role in ("seller","admin")  # для совместимости
...
class Car(db.Model, TimestampMixin):
    ...
    sales = db.relationship('Sale', back_populates='car', cascade='all,delete')
...
class Customer(db.Model, TimestampMixin):
    ...
    sales = db.relationship('Sale', back_populates='customer', cascade='all,delete')
...
class Employee(db.Model, TimestampMixin):
    ...
    sales = db.relationship('Sale', back_populates='employee', cascade='all,delete')
